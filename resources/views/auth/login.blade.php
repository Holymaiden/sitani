...
@section('content')
<div>
    <div><a class="logo" href="index.html"><img class="img-fluid for-light" style="height:100px; width:100p" src="{{ url('grocee/img/logo/icon-mini.png') }}" alt="logo image"></a></div>
            ...
            <div class="form-group mb-0">
                <div class="checkbox p-0">
                    ...
                    <div class="text-end mt-3">
                        <button class="btn  btn-block w-100" type="submit" style="background:#3CB815; color:white">Sign in </button>
                    </div>
                </div>

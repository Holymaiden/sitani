                        ...
                        <div class="row row-cols-1">
                                <div class="col">
                                        <div class="breadcrumb__content text-center">
                                                <h1 class="breadcrumb__content--title text-white mb-25">Kritik Dan Saran</h1>
                                                <ul class="breadcrumb__content--menu d-flex justify-content-center">
                                                        <li class="breadcrumb__content--menu__items"><a class="text-white" href="index.html">Home</a></li>
                                                        <li class="breadcrumb__content--menu__items"><span class="text-white">Kritik Dan Saran</span></li>
                                                </ul>
                                        </div>
                                </div>
                        </div>
        ...
        <section class="contact__section section--padding">
                <div class="container">
                        <div class="section__heading text-center mb-40">
                                <span class="section__heading--subtitle">Contact With Me</span>
                        </div>
                        <div class="main__contact--area position__relative">
                                ...
                                <div class="contact__form">
                                        ...
                                        <form class="contact__form--inner" action="{{ route('user.kritik-saran-store') }}" method="POST">
                                                @csrf
                                                <div class="row">
                                                        <div class="col-lg-6 col-md-6">
                                                                <div class="contact__form--list mb-20">
                                                                        <label class="contact__form--label" for="input1">Desa <span class="contact__form--label__star">*</span></label>
                                                                        <select class="contact__form--input" name="desa_id" id="input1">
                                                                                <option value="0">Luar Desa</option>
                                                                                @foreach(Helper::get_data('desas') as $item)
                                                        ...
                                                        <div class="col-lg-6 col-md-6">
                                                                <div class="contact__form--list mb-20">
                                                                        <label class="contact__form--label" for="input2">Nama <span class="contact__form--label__star">*</span></label>
                                                                        <input class="contact__form--input" name="nama" id="input2" placeholder="Your Name" type="text">
                                                                </div>
                                                        </div>
                                                        <div class="col-lg-12 col-md-12">
                                                                <div class="contact__form--list mb-20">
                                                                        <label class="contact__form--label" for="input3">Phone Number <span class="contact__form--label__star">*</span></label>
                                                                        <input class="contact__form--input" name="hp" id="input3" placeholder="Phone number" type="text">
                                                                </div>
                                                        </div>
                                                        <div class="col-12">
                                                                <div class="contact__form--list mb-15">
                                                                        <label class="contact__form--label" for="input5">Write Your Message <span class="contact__form--label__star">*</span></label>
                                                                        <textarea class="contact__form--textarea" name="isi" id="input5" placeholder="Write Your Message"></textarea>
                                                                </div>
                                                        </div>
                                                </div>

                        ...
                        <div class="row row-cols-1">
                                <div class="col">
                                        <div class="breadcrumb__content text-center">
                                                <h1 class="breadcrumb__content--title text-white mb-25">Hasil Panen</h1>
                                                <ul class="breadcrumb__content--menu d-flex justify-content-center">
                                                        <li class="breadcrumb__content--menu__items"><a class="text-white" href="{{ route('home') }}">Home</a></li>
                                                        <li class="breadcrumb__content--menu__items"><span class="text-white">Hasil Panen</span></li>
                                                </ul>
                                        </div>
                                </div>
                        </div>
        ...
        <section class="blog__section section--padding">
                <div class="container">
                        <div class="section__heading text-center mb-40">
                                <span class="section__heading--subtitle">Hasil Panen Kami</span>
                        </div>
                        <div class="blog__section--inner">
                                <div class="row row-cols-lg-3 row-cols-md-2 row-cols-sm-2 row-cols-2 mb--n30">

                                        @foreach($panen as $i => $v)
                                        <div class="col custom-col mb-30">
                                                <div class="blog__items">
                                                        <div class="blog__items--thumbnail">
                                                                <img class="blog__items--img" src="{{ url('uploads/panen/'.$v->gambar) }}" alt="blog-img" style="width: -webkit-fill-available;">
                                                        </div>
                                                                ...
                                                                <div class="blog__items--meta">
                                                                        <ul class="d-flex">
                                                                                <li class="blog__items--meta__list">
                                                                                        ...
                                                                                        <span class="blog__items--meta__text">{{ $v->lahan->anggota->kelompok->desa->nama }}</span>
                                                                                </li>
                                                                                <li class="blog__items--meta__list">
                                                                                        <svg class="blog__items--meta__icon" xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 15 15">
                                                                                        ...
                                                                                        <span class="blog__items--meta__text">{{ date('d M Y',strtotime($v->tanggal_tanam)) }} sd {{ date('d M Y',strtotime($v->tanggal_panen)) }}</span>
                                                                                </li>
                                                                        </ul>
                                                                </div>
                                                                <h3 class="blog__items--title">{{ $v->lahan->anggota->nama }}</h3>
                                                                <p class="blog__items--desc">
                                                                        Panen Berhasil : {{ $v->jumlah_panen }} {{ $v->satuan_panen }} </br>
                                                                        Panen Gagal : {{ $v->jumlah_gagal }} {{ $v->satuan_gagal }} </br>

                        ...
                        <form id="formInput" name="formInput" action="">
                                ...
                                <div class="modal-body">
                                        <div class="row g-1">
                                                <div class="col-md-6">
                                                        <label>Bantuan</label>
                                                        <select class="form-control" name="bantuan_id" id="bantuan_id" required>
                                                                @foreach(Helper::get_data('bantuans') as $v)
                                        ...
                                        <div class="row g-1 mt-1">
                                                <div class="col-md-12">
                                                        <label>Pemberi</label>
                                                        <input type="text" class="form-control" name="pemberi" id="pemberi" required />
                                                </div>
                                        </div>
        ...
        function editForm(id) {
                ...
                $.ajax({
                        ...
                        success: function(data) {
                                ...
                                $('#formId').val(data.id);
                                $('#_method').val('PUT');
                                $('#bantuan_id').val(data.bantuan_id).trigger('change');

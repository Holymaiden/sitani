...
<script type="text/javascript">
        ...
        function showForm(id) {
                ...
                $.ajax({
                        ...
                        success: function(data) {
                                $("#headFormShow").empty();
                                $("#headFormShow").append("Form Edit");
                                $('#showModel').modal('show');
                                $('#show_lahan').empty();
                                $('#show_lahan').append(data.lahan_anggota.anggota.nama);
                                $('#show_bantuan').empty();
                                $('#show_bantuan').append(data.masuk_bantuan.bantuan.nama);
                                $('#show_jumlah_bantuan').empty();
                                $('#show_jumlah_bantuan').append(data.masuk_bantuan.jumlah);
                                $('#show_satuan_bantuan').empty();
                                $('#show_satuan_bantuan').append(data.masuk_bantuan.satuan);
                                $('#show_tanggal_tanam').empty();
                                $('#show_tanggal_tanam').append(data.tanggal_tanam);
                                $('#show_tanggal_panen').empty();
                                $('#show_tanggal_panen').append(data.tanggal_panen);
                                $('#show_jumlah_panen').empty();
                                $('#show_jumlah_panen').append(data.jumlah_panen);
                                $('#show_satuan_panen').empty();
                                $('#show_satuan_panen').append(data.satuan_panen);
                                $('#show_jumlah_gagal').empty();
                                $('#show_jumlah_gagal').append(data.jumlah_gagal);
                                $('#show_satuan_gagal').empty();
                                $('#show_satuan_gagal').append(data.satuan_gagal);
                                $('#show_keterangan').empty();
                                $('#show_keterangan').append(data.keterangan);
                                $('#show_gambar').empty();
                                $('#show_gambar').attr("src", "{{ url('uploads/panen') }}/" + data.gambar);
                        },
                        error: function() {
                                var setting = {
                                        type: 'danger',
